...
INSERT INTO tribal_orders (id, ordered_at, amount, status)
SELECT 
  id,
...
-- -----------------------------------------------
CREATE INDEX idx_customer_ordered_at ON tribal_orders(id, ordered_at);
...
-- SELECT * FROM tribal_orders WHERE amount > 500 ORDER BY ordered_at DESC;

-- Optimized query using index
-- SELECT * FROM tribal_orders WHERE id = 1234 ORDER BY ordered_at DESC;
